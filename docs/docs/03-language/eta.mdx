...
- For more details about Eta.js check the official [documentation](https://eta.js.org/docs/intro/template-syntax) or a (cheatsheet)[https://eta.js.org/docs/intro/syntax-cheatsheet]<!-- - Learn how to [Patch YAML](./yaml-patch.md) after templates are rendered   -->
- Explore [Alternates](./disable-file.md) to enable/disable files and folders for different device variants
